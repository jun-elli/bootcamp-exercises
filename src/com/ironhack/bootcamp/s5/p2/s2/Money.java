...
/**
 * A significant part of working as a developer is working with existing code that you did not author.
 * This can be difficult at first but gets easier with practice. For the remainder of the class,
 * we will use the Money class below for all applications dealing with money.
 * Read through it carefully with your partner.
 * Remember you don't need to know how everything works; you only need to understand what each method does.
 * Spend extra time looking through the method signatures.
 */
public class Money {
